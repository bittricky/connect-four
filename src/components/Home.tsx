      ...
      <div className="space-y-4 w-full max-w-sm">
        {!showDifficulty ? (
          <>
            ...
            <motion.button
              ...
              onClick={() => {
                onStartGame("player"); // Player vs Player mode
                navigate("/Game");
              }}
            >
          ...
          <div className="space-y-3">
            ...
            {difficulties.map((diff, index) => (
              <motion.button
                ...
                } p-4 rounded-xl shadow-lg font-semibold`}
        ...
        {showDifficulty && (
          <motion.button
            ...
            whileTap="tap"
            transition={{ type: "spring", delay: 0.3 }}
            className="w-full bg-green-600 text-white p-4 rounded-xl shadow-lg font-semibold mt-4"
